...
export default function LoginPage() {
  ...
  return (
    <div className="flex-1 flex items-center justify-center px-4 py-12 bg-slate-950 relative overflow-hidden">
      ...
      <div className="absolute bottom-1/4 left-1/3 -translate-x-1/2 w-[300px] h-[300px] bg-purple-500/10 rounded-full blur-3xl pointer-events-none" />
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', textAlign: 'center' }}>
          ...
          <p className="text-sm text-slate-400">
            Sign in to start optimizing your study plan
          </p>
        </div>
